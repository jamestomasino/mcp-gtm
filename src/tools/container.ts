  ...
  return [
    {
      ...
      description: "Load a GTM container JSON file. Call this first before using any other tools.",
      parameters: z.object({
    ...
    },
    {
      ...
      description: "Get container metadata (name, ID, timezone, platform). Requires a loaded container.",
      parameters: z.object({}),
      handler: async () => {
        const info = store.containerInfo;
        return {
    ...
    },
    {
      ...
      description: "Get summary counts and structure overview of the loaded container.",
      parameters: z.object({}),
      handler: async () => {
        return {
          content: [{ type: "text" as const, text: JSON.stringify({
